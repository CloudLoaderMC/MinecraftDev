...
data class CloudPackDescriptor(val format: Int, val comment: String) {
    companion object {
        // Current data from https://github.com/CloudLoaderMC/MinecraftForge/blob/0ff8a596fc1ef33d4070be89dd5cb4851f93f731/mdk/src/main/resources/pack.mcmeta
        val FORMAT_3 = CloudPackDescriptor(
            3,
        ...
        val FORMAT_7 = CloudPackDescriptor(7, "")
        val FORMAT_8 = CloudPackDescriptor(8, "")
        val FORMAT_9 = CloudPackDescriptor(9, "")

        // See https://minecraft.gamepedia.com/Tutorials/Creating_a_resource_pack#.22pack_format.22
        fun forMcVersion(version: SemanticVersion): CloudPackDescriptor? = when {
