...
object Fg2Template : BaseTemplate() {
    ...
    fun applyMainClass(
        ...
        config: com.demonwav.mcdev.platform.cloud.creator.CloudProjectConfig,
        packageName: String,
        className: String
    ): String {
        val props = mapOf(
    ...
    fun applyBuildGradle(project: Project, buildSystem: BuildSystem, mcVersion: SemanticVersion): String {
        val props = mapOf(
            "FORGEGRADLE_VERSION" to com.demonwav.mcdev.platform.cloud.creator.Fg2Template.fgVersion(mcVersion),
